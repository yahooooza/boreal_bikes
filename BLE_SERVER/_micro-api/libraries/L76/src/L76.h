/*
  ...
  Update: This library has been updated for L76 GPS use case.
...
#define L76_ADDR 0x10 //7-bit unshifted default I2C Address
...
public:
	...
	//By default use Wire, standard I2C speed, and the default L76 address
	boolean begin(TwoWire &wirePort = Wire, uint32_t i2cSpeed = I2C_SPEED_STANDARD, uint8_t sdapin = -1, uint8_t sclpin = -1);
